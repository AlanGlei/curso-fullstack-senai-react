...
function ModalTarefa({
  ...
  }, [aberto, onFechar]); // roda quando aberto ou onFechar mudar
  ...
  //     consultarCidade(apenasNumeros);
  //   } else {
  //     setCidade(""); // limpa a cidade se o CEP estiver incompleto
  //   }
  // }, [cep]);
  ...
  if (!aberto) return null; // não renderiza se fechado
